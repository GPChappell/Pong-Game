...
var Board = function () {
  ...
  _createClass(Board, [{
    ...
    value: function render(svg) {
      ...
      svg.setAttributeNS(null, 'width', this.width);
      svg.setAttributeNS(null, 'height', this.height);
      svg.setAttributeNS(null, 'fill', '#353535');
      ...
      svg.setAttributeNS(null, 'x1', this.width / 2);
      svg.setAttributeNS(null, 'y1', 0);
      svg.setAttributeNS(null, 'x2', this.width / 2);
      svg.setAttributeNS(null, 'y2', this.height);
      svg.setAttributeNS(null, 'stroke', 'darkgrey');
      svg.setAttributeNS(null, 'stroke-width', '3');
      svg.setAttributeNS(null, 'stroke-dasharray', '5');
